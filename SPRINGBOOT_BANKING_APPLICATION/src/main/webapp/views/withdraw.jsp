...
<div class="topnav">
  ...
  <a href="/aboutus">About Us</a>
	...
	<form action="/withdrawbalance">
		...
		<label for="name"><b>Withdraw Amount</b></label> 
		<input type="text" placeholder="Enter Amount" name="withdrawamount" required><br>
		
		<hr>
		<button type="submit" class="registerbutton">Withdraw</button>
