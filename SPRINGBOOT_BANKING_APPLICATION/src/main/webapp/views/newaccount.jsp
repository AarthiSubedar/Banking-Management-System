...
<div class="topnav">
  ...
  <a href="/aboutus">About Us</a>
	...
	<form action="/save">
		...
		<input type="password" placeholder="Enter Confirm Password" name="confirmpassword" required><br>
		...
		<input type="text" placeholder="Enter Mobile Number" name="mobileno" required><br>
		
		<label for="number"><b>Status</b></label> 
		<input type="text" placeholder="Enter Account Status" name="status" required><br>
		<hr>
